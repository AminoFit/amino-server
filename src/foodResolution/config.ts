...
export function foodConfig(userId: string, env: NodeJS.ProcessEnv = process.env,
  ...
  if (features.fast_selector === "off" || features.agent_fallback !== features.fast_selector) features.agent_fallback = "off"
  return Object.freeze({ version: "jev-gemini-live-v1", telemetry: env.FOOD_BASELINE_TELEMETRY === "true",
