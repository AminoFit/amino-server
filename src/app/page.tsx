                ...
                <div>
                  <div className="relative mt-2 rounded-md shadow-sm">
                    <input
                      ...
                      name="phone-number"
                      id="phone-number"
                      className="block w-full rounded-md border-0 p-3.5  text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
