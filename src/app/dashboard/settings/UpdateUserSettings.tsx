...
import { updateUserPreferences, updateUserSettings } from "./actions"
...
export default function UpdateUserSettings({ user }: { user: Tables<"User"> }) {
  ...
  const [birthDayRead, birthMonthRead, birthYearRead] = user.dateOfBirth
    ? extractDateParts(new Date(user.dateOfBirth))
    : ["", "", ""]
  ...
  const handleSubmitPersonalInfo = async () => {
    ...
    await updateUserSettings({ tzIdentifier, fullName, dateOfBirth, weightKg, heightCm })
      .then(() => {
        setSubmittingPersonal(false)
        setSuccessMessagePersonal("Successfully updated your personal information")
      })
      .catch(() => {
  ...
  const handleSavePreferences = async () => {
    ...
    await updateUserPreferences({ unitPreference })
      .then(() => {
        ...
        setSuccessMessagePreferences("Successfully updated your preferences")
      })
      .catch(() => {
    ...
    <main>
      ...
      <div className="divide-y divide-grey/5">
          ...
          <div className="md:col-span-2">
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                <label htmlFor="full-name" className="block text-sm font-medium leading-6 text-grey">
                  Full name
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="sm:col-span-6 col-span-full">
                ...
                >
                  {tzData.map((tz) => {
                    const options = []
                    options.push(
                      <option value={tz.utc[0]} key={tz.text + "space"} disabled>
                        &nbsp;
                      </option>
                    )
                    options.push(
              ...
              <div className="sm:col-span-6 col-span-full">
                <label className="block text-sm font-medium leading-6 text-grey">Date of Birth</label>
                <label className="block text-xs font-light leading-6 text-gray-600">(MM/DD/YYYY)</label>
              ...
              <div className="sm:col-span-3 col-span-full">
                <label className="block text-sm font-medium leading-6 text-grey">Height</label>
                <div className="mt-2 flex gap-x-2 items-center">
              ...
              <div className="sm:col-span-3 col-span-full">
                <label className="block text-sm font-medium leading-6 text-grey">Weight</label>
                <div className="mt-2 flex gap-x-2 items-center">
                  {unitPreference === "METRIC" ? (
                    <>
                      <input
            ...
            {successMessagePersonal && <div className="mt-8 flex text-sm text-green-600">{successMessagePersonal}</div>}
          </div>
        </div>

        <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
          <div>
            <h2 className="text-base font-semibold leading-7 text-grey">Preferences</h2>
            <p className="mt-1 text-sm leading-6 text-gray-400">Choose your unit preferences.</p>
          </div>
          ...
          <div className="md:col-span-2">
                    ...
                    <div className="relative mt-1">
                      <Listbox.Button className="relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                        <span className="block truncate">
                          {unitOptions.find((option) => option.value === unitPreference)?.name || unitPreference}
                        </span>
            ...
            {successMessagePreferences && (
              <div className="mt-8 flex text-sm text-green-600">{successMessagePreferences}</div>
            )}
          </div>
        </div>
        ...
        <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8 opacity-20 pointer-events-none">
          <div>
            <h2 className="text-base font-semibold leading-7 text-grey">Change password</h2>
          ...
          <form className="md:col-span-2">
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
              <div className="col-span-full">
                <label htmlFor="current-password" className="block text-sm font-medium leading-6 text-grey">
                  Current password
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="col-span-full">
                <label htmlFor="new-password" className="block text-sm font-medium leading-6 text-grey">
                  New password
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="col-span-full">
                <label htmlFor="confirm-password" className="block text-sm font-medium leading-6 text-grey">
                  Confirm password
                </label>
                <div className="mt-2">
                  <input
        ...
        <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8 opacity-20 pointer-events-none">
          <div>
            <h2 className="text-base font-semibold leading-7 text-grey">Delete account</h2>
