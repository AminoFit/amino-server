...
const tiers = [
  {
    ...
    priceMonthly: "Free",
    description:
      "Log your workouts and meals, and track your progress over time.",
    features: [
      "Track up to 5 foods per day",
  ...
  },
  {
    ...
    href: "#",
    priceMonthly: "$10",
    description: "Unlimited tracking of workouts, meals, and more.",
    features: [
      "Unlimited meals tracked",
      "Unlimited workouts tracked",
      "Advanced analytics",
  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
        Get started with our free plan and see if you need to upgrade.
      </p>
